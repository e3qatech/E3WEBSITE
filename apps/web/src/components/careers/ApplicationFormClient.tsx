...
export function ApplicationFormClient({ locale }: ApplicationFormClientProps) {
  ...
  return (
    <div
      className="bg-zinc-900/40 backdrop-blur-md border border-zinc-800/50 p-8 md:p-12 rounded-2xl shadow-2xl"
      dir={dir}
    >
      {/* Header & Navigation */}
      <div className="mb-6">
