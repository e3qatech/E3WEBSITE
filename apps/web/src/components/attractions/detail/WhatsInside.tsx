...
export function WhatsInside({ description, features, imageUrl, locale = 'en' }: WhatsInsideProps) {
  ...
  return (
    <section className="py-24 md:py-36 bg-[var(--surface-default)] text-[var(--text-primary)] relative overflow-hidden" dir={isAr ? "rtl" : "ltr"}>
      {/* Background Glow */}
                ...
                >
                  ...
                  <div className="relative z-10 flex-1 flex flex-col justify-between space-y-8">
                    ...
                    <div className="flex items-center justify-between gap-4">
                      <div className="p-3.5 rounded-2xl bg-[var(--surface-hover)] border border-[var(--border-level-2)] text-emerald-600 dark:text-emerald-400 group-hover:scale-110 group-hover:bg-emerald-500/20 group-hover:border-emerald-500/50 transition-all duration-500 ease-out shadow-sm">
                        {feature.iconUrl ? (
