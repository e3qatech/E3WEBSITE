    ...
    <div className="p-6 max-w-5xl mx-auto space-y-8 text-white">
      ...
      <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 space-y-6 backdrop-blur-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-semibold text-slate-300 mb-1">Page Main Title (English)</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-300 mb-1">Page Main Title (Arabic)</label>
            <input
              type="text"
              dir="rtl"
