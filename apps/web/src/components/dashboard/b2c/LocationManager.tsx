...
const DEFAULT_STYLE_URL = process.env.NEXT_PUBLIC_MAP_STYLE_URL || 'https://tiles.openfreemap.org/styles/dark';
...
export function LocationManager() {
  ...
  // Initialize MapLibre Interactive Picker in Drawer
  useEffect(() => {
            ...
            >
              <div className="space-y-6">
                ...
                <form onSubmit={handleSave} className="space-y-6">
                  ...
                  {/* MapLibre Pin Picker Canvas */}
                  <div className="space-y-2">
                    <label className="block text-xs font-mono font-bold text-[var(--text-tertiary)] uppercase">
                      Map Placement (Click or Drag Marker)
                    </label>
                    <div ref={mapContainerRef} className="w-full h-56 rounded-2xl border border-[var(--border-level-2)] overflow-hidden shadow-inner relative" />
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="block text-xs font-mono font-bold text-[var(--text-tertiary)] uppercase mb-1">Cover Photo Media URL</label>
                      <input
                        type="text"
