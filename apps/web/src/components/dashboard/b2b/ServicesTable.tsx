            ...
            <tbody className="divide-y divide-[var(--border-default)]">
              {filtered.length === 0 ? (
                ...
                filtered.map(service => (
                  <tr key={service.id} className="hover:bg-[var(--surface-hover)]/50 transition-colors">
                    <td className="p-4">
                      <input 
                        type="checkbox" 
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-bold text-[var(--text-primary)]">{service.titleEn}</p>
                          <p className="text-xs text-[var(--text-secondary)] mt-0.5">{service.titleAr}</p>
                        </div>
                      </div>
                    </td>
                    <td className="p-4">
                      <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold ${service.isVisible ? 'bg-green-500/10 text-green-500' : 'bg-[var(--surface-active)] text-[var(--text-tertiary)]'}`}>
                    ...
                    <td className="p-4">
                      {service.isFeatured ? (
                        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-[var(--color-primary)]/10 text-[var(--color-primary)]">
                          Featured
                        </span>
                      ) : (
