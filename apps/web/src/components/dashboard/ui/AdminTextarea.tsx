    ...
    return (
      <div className={cn("flex flex-col gap-1.5", fullWidth && "w-full", className)}>
        ...
        <textarea
          ...
          disabled={disabled}
          className={cn(
            "flex min-h-[80px] w-full rounded-md border bg-surface-default px-3 py-2 text-sm text-text-primary transition-colors placeholder:text-text-tertiary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:border-primary disabled:cursor-not-allowed disabled:opacity-50",
