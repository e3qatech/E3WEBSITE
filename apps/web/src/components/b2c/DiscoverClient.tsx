...
export function DiscoverClient({ locale, initialSettings }: { locale: string; initialSettings: any }) {
  ...
  return (
    <div className="min-h-screen bg-[#0F0F23] text-slate-200 font-['Poppins',sans-serif] selection:bg-emerald-500/30 overflow-x-hidden relative" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 md:px-8 text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-['Righteous',sans-serif] tracking-normal mb-8 bg-clip-text text-transparent bg-gradient-to-br from-emerald-300 via-rose-400 to-emerald-600 drop-shadow-lg">
              {locale === 'ar' ? hero.titleAr : hero.titleEn}
            </h1>
            <p className="text-lg md:text-2xl text-emerald-200 max-w-3xl mx-auto leading-relaxed font-light whitespace-pre-wrap">
      ...
      <section className="relative py-32 border-t border-emerald-900/30 bg-[#0B0B1A]/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            ...
            <div className="relative h-64 md:h-96 rounded-2xl border border-emerald-900/50 bg-[#13132B] overflow-hidden group shadow-[0_0_40px_rgba(124,58,237,0.1)]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-emerald-400 font-mono text-sm tracking-[0.3em] uppercase opacity-70 group-hover:text-rose-400 transition-colors duration-300 drop-shadow-[0_0_8px_rgba(244,63,94,0.8)]">E3 Archives</span>
              </div>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#151530]/60 backdrop-blur-md border border-emerald-900/40 rounded-2xl p-8 hover:bg-[#1A1A3A]/80 hover:border-emerald-500/50 hover:shadow-[0_0_30px_rgba(124,58,237,0.15)] transition-all duration-300 group">
              <Target className="w-10 h-10 text-emerald-400 mb-6 group-hover:scale-110 transition-transform duration-300 group-hover:text-emerald-300" />
            ...
            <div className="bg-[#151530]/60 backdrop-blur-md border border-emerald-900/40 rounded-2xl p-8 hover:bg-[#1A1A3A]/80 hover:border-rose-500/50 hover:shadow-[0_0_30px_rgba(244,63,94,0.15)] transition-all duration-300 group">
            ...
            <div className="bg-[#151530]/60 backdrop-blur-md border border-emerald-900/40 rounded-2xl p-8 hover:bg-[#1A1A3A]/80 hover:border-emerald-400/50 hover:shadow-[0_0_30px_rgba(167,139,250,0.15)] transition-all duration-300 group">
              <Heart className="w-10 h-10 text-emerald-400 mb-6 group-hover:scale-110 transition-transform duration-300 group-hover:text-emerald-300" />
      ...
      <section className="relative py-32 bg-[#0F0F23]">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-emerald-400 font-mono text-sm uppercase tracking-[0.2em]">{initialSettings?.corporateRosterSubtitle || "Leadership & Engineering Core"}</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {team.map((member: { name: string; role: string; desc: string }, i: number) => (
              ...
              >
                <div className="absolute top-0 start-0 w-full h-1 bg-gradient-to-r from-transparent via-rose-500 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div className="w-16 h-16 rounded-full bg-[#1A1A3A] mb-6 border border-emerald-900/50 flex items-center justify-center text-emerald-300 font-bold text-xl shadow-[0_0_15px_rgba(124,58,237,0.2)] group-hover:shadow-[0_0_20px_rgba(244,63,94,0.4)] group-hover:border-rose-500/50 transition-all duration-300">
      ...
      <section className="relative py-32 border-t border-emerald-900/30 bg-[#0B0B1A]">
        <div className="max-w-5xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-emerald-300">{initialSettings?.bookingsSubtitle || "Generate high-value inquiries for specialized corporate and VIP celebrations."}</p>
          </div>

          <div className="bg-[#13132B] border border-emerald-900/40 rounded-3xl p-3 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
            <Tabs defaultValue="corporate" className="w-full">
              <TabsList className="grid grid-cols-2 bg-[#0A0A18] p-2 rounded-2xl mb-8 border border-[#2A2A50]">
                <TabsTrigger value="corporate" className="rounded-xl data-[state=active]:bg-[#1D1D3D] data-[state=active]:text-emerald-400 data-[state=active]:shadow-[0_0_15px_rgba(124,58,237,0.2)] transition-all">Corporate Events</TabsTrigger>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div>
                      ...
                      <ul className="space-y-4 text-slate-300 mb-8">
                        <li className="flex gap-3 items-center"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 drop-shadow-[0_0_8px_rgba(124,58,237,0.6)]"/> Specialized family days</li>
                        <li className="flex gap-3 items-center"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 drop-shadow-[0_0_8px_rgba(124,58,237,0.6)]"/> Professional catering lists</li>
                        <li className="flex gap-3 items-center"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 drop-shadow-[0_0_8px_rgba(124,58,237,0.6)]"/> Venue privatization (InflataPark)</li>
                        <li className="flex gap-3 items-center"><CheckCircle2 className="w-5 h-5 text-emerald-500 shrink-0 drop-shadow-[0_0_8px_rgba(124,58,237,0.6)]"/> Custom on-site branding</li>
                      </ul>
                    </div>
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-slate-300 text-lg mb-8 leading-relaxed whitespace-pre-wrap" dangerouslySetInnerHTML={{ __html: (careers.description || "").replace(/(freelance event crew staffing|Lusail corporate office)/g, '<strong class="text-emerald-300 font-semibold">$1</strong>') }}></p>
              <div className="bg-[#13132B] border border-emerald-900/40 shadow-[0_5px_20px_rgba(0,0,0,0.2)] rounded-xl p-6">
            ...
            {/* Drag & Drop Panel */}
            <div 
              className={`relative border-2 border-dashed rounded-3xl p-12 text-center transition-all duration-300 ${dragActive ? 'border-emerald-400 bg-emerald-900/10 scale-[1.02] shadow-[0_0_30px_rgba(124,58,237,0.15)]' : 'border-[#2A2A50] hover:border-emerald-500/50 bg-[#13132B]/60'}`}
            ...
            >
              {uploadState === "idle" && (
                <div className="pointer-events-none">
                  <div className="w-20 h-20 mx-auto bg-[#1A1A3A] border border-emerald-900/50 rounded-full flex items-center justify-center mb-6 shadow-[0_0_15px_rgba(0,0,0,0.5)]">
                  ...
                  <Button variant="outline" className="border-emerald-500/50 text-emerald-300 hover:bg-emerald-900/30 hover:text-white relative z-10 pointer-events-auto rounded-xl px-8 tracking-wide">
                    Browse Files
              ...
              {uploadState === "uploading" && (
                <div className="py-8">
                  ...
                  <p className="text-emerald-400 font-mono text-sm tracking-widest animate-pulse">NLP Extracting Skills...</p>
                </div>
              )}

              {uploadState === "success" && (
                <div className="py-8">
                  <div className="w-20 h-20 bg-emerald-900/30 border border-emerald-500/30 rounded-full flex items-center justify-center mx-auto mb-6 shadow-[0_0_30px_rgba(124,58,237,0.2)]">
                    <CheckCircle2 className="w-10 h-10 text-emerald-400 drop-shadow-[0_0_8px_rgba(124,58,237,0.8)]" />
                  </div>
                  <h3 className="text-xl font-bold text-emerald-400 mb-2 tracking-wide">Profile Ingested</h3>
...
function BookingForm({ type, accentColor = "purple" }: { type: string, accentColor?: "purple" | "rose" }) {
  ...
  const focusRing = isRose ? "focus:ring-rose-500 focus:border-rose-500" : "focus:ring-emerald-500 focus:border-emerald-500";
  const successBg = isRose ? "bg-rose-900/10 border-rose-500/20" : "bg-emerald-900/10 border-emerald-500/20";
  const successText = isRose ? "text-rose-400" : "text-emerald-400";
  const successIcon = isRose ? "text-rose-500 drop-shadow-[0_0_8px_rgba(244,63,94,0.6)]" : "text-emerald-500 drop-shadow-[0_0_8px_rgba(124,58,237,0.6)]";
