      ...
      <E3LivingHero
        ...
        rotatingWordsEn={
          Array.isArray(initialSettings?.rotatingWordsEn) && initialSettings.rotatingWordsEn.length > 0
            ...
            : ["PLAY", "CELEBRATION", "DISCOVERY", "MEMORIES"]
        }
        rotatingWordsAr={
          Array.isArray(initialSettings?.rotatingWordsAr) && initialSettings.rotatingWordsAr.length > 0
            ? initialSettings.rotatingWordsAr
            : ["المرح", "الاحتفال", "الاكتشاف", "الذكريات"]
        }
        descriptionEn={heroDesc}
        descriptionAr={heroDesc}
        primaryCta={{
          labelEn: primaryCta,
          labelAr: primaryCta,
        ...
        secondaryCta={{
          labelEn: secondaryCta,
          labelAr: secondaryCta,
          onClick: () => {
