...
export function PublicQuotationView({ quotation, locale }: PublicQuotationViewProps) {
  ...
  const termsConditions = pkg?.termsConditions || {}
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-level-0)] text-[var(--text-primary)] font-poppins py-8 px-4 sm:px-6 lg:px-8 print:p-0 print:bg-white print:text-slate-900" dir={dir}>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-[var(--surface-default)] print:bg-white border border-[var(--border-level-1)] rounded-3xl p-6 sm:p-10 shadow-xl print:shadow-none print:border-none space-y-8">
          {/* Header Banner */}
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 border-b border-[var(--border-level-1)] pb-6">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <div className="w-8 h-8 rounded-xl bg-[var(--e3-royal-blue)] text-white flex items-center justify-center font-black text-sm shadow-md">
                  E3
                </div>
                <span className="font-black text-lg tracking-tight">E3 QATAR</span>
                <span className="text-xs px-2.5 py-0.5 rounded-full bg-[var(--color-primary)]/10 text-[var(--color-primary)] font-mono font-bold uppercase">
                  Official Proposal
                </span>
              </div>
              ...
              <p className="text-xs text-[var(--text-secondary)] mt-1">
                {isAr
                  ? "مؤسسة إي ثري للترفيه — الدوحة، دولة قطر • السجل التجاري والفعاليات"
                  : "E3 Entertainment LLC — Doha, State of Qatar • Premium Events & Celebrations"}
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-8 pt-8 border-t border-[var(--border-level-1)] text-xs text-[var(--text-secondary)]">
            <div className="space-y-4">
              <span className="font-bold block text-[var(--text-primary)]">
                {isAr ? "اعتماد مؤسسة إي ثري للترفيه:" : "Issued by E3 Qatar Events:"}
              </span>
              <div className="h-12 border-b border-dashed border-[var(--border-level-1)] flex items-end font-mono text-[11px] text-[var(--text-tertiary)] pb-1">
