...
export const MANAGED_CMS_PAGES: Record<string, ManagedPageRegistryEntry> = {
  ...
  'b2b-leadership': {
    slug: 'b2b-leadership',
    nameEn: 'B2B Leadership & Team Page',
    nameAr: 'صفحة القيادة وفريق العمل (B2B)',
    specializedEditorPath: '/dashboard/b2b/leadership',
    canonicalApiEndpoint: '/api/cms/pages/b2b-team-page',
    domain: 'B2B',
    descriptionEn: 'Executive perspectives, chairman statements, human constellation hero, and leadership SEO.',
    descriptionAr: 'رؤية القيادة التنفيذية، كلمة رئيس مجلس الإدارة، كوكبة الفريق، والبيانات الوصفية.',
    isSpecialized: true,
  },
  'b2b-team-page': {
    slug: 'b2b-team-page',
    nameEn: 'B2B Team Page (Alias)',
    nameAr: 'صفحة فريق العمل (اسم بديل)',
    specializedEditorPath: '/dashboard/b2b/leadership',
    canonicalApiEndpoint: '/api/cms/pages/b2b-team-page',
    domain: 'B2B',
    descriptionEn: 'Alias for B2B Leadership & Team Page Editor.',
    descriptionAr: 'اسم بديل لمحرر صفحة القيادة وفريق العمل.',
    isSpecialized: true,
  },
  'b2c-packages-page': {
