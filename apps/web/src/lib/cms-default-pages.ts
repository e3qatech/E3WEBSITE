...
export function getMergedCMSPageContent(slug: string, rawContent?: any) {
  ...
  return {
    ...
    hero: {
      ...defaults.hero,
      ...(raw.hero || {}),
      headerEn: raw.hero?.headerEn || defaults.hero.headerEn,
      headerAr: raw.hero?.headerAr || defaults.hero.headerAr,
      subHeaderEn: raw.hero?.subHeaderEn || defaults.hero.subHeaderEn,
      subHeaderAr: raw.hero?.subHeaderAr || defaults.hero.subHeaderAr,
      mediaUrl: raw.hero?.mediaUrl || defaults.hero.mediaUrl,
    },
    maskedVideo: {
      ...defaults.maskedVideo,
      ...(raw.maskedVideo || {}),
      customerDesktopVideo: raw.maskedVideo?.customerDesktopVideo || defaults.maskedVideo.customerDesktopVideo,
      customerPoster: raw.maskedVideo?.customerPoster || defaults.maskedVideo.customerPoster,
      organizerDesktopVideo: raw.maskedVideo?.organizerDesktopVideo || defaults.maskedVideo.organizerDesktopVideo,
      organizerPoster: raw.maskedVideo?.organizerPoster || defaults.maskedVideo.organizerPoster,
    },
