...
export const DASHBOARD_SEGMENT_MAP: Record<string, { en: string; ar: string }> = {
  ...
  marketing: { en: "Marketing & Growth", ar: "التسويق والنمو" },
  influencers: { en: "Influencer Management", ar: "إدارة المؤثرين وصناع المحتوى" },
  directory: { en: "Creator Directory", ar: "دليل صناع المحتوى" },
  campaigns: { en: "Influencer Campaigns", ar: "حملات المؤثرين" },
  "content-review": { en: "Content Review Queue", ar: "مراجعة واعتماد المحتوى" },
  reports: { en: "Performance Reports", ar: "تقارير الأداء والنتائج" },
