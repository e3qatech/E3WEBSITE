...
export function buildLocalBusinessSchema(options?: LocalBusinessSchemaOptions) {
  ...
  return {
    ...
    name: isAr
      ? 'إي ثري قطر - تنظيم الفعاليات والمؤتمرات والترفيه'
      : 'E3 Qatar - Events & Entertainment Enterprises',
    alternateName: [
      'E3',
      'E3 Qatar',
    ...
    description: isAr
      ? 'الشركة الرائدة في قطر لتنظيم الفعاليات والمؤتمرات والمعارض وتطوير الوجهات الترفيهية العائلية بالدوحة.'
    ...
    telephone: options?.telephone || '+974 4400 0000',
