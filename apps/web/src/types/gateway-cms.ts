...
export const DEFAULT_GATEWAY_CMS_PAYLOAD: GatewayCustomizationPayload = {
  ...
  seoAccess: {
    seoTitleEn: 'Events & Entertainment Enterprises (E3 Qatar) | Premier Live Events, Production & Attractions',
    seoTitleAr: 'إيفنتس آند إنترتينمنت إنتربرايزس (إي ثري قطر) | تنظيم الفعاليات الكبرى وتطوير الوجهات',
    ...
    ogImage: 'https://eeeqa.com/og-image-gateway.jpg',
