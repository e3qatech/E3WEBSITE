        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 items-center">
            <a 
              ...
              className="relative group px-10 py-5 bg-emerald-500 text-zinc-950 font-black uppercase tracking-[0.2em] rounded-2xl hover:bg-emerald-400 transition-all duration-300 overflow-hidden shadow-2xl"
            >
