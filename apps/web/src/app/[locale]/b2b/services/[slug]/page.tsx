    ...
    <div className="flex flex-col w-full bg-zinc-950 min-h-screen" dir={isAr ? 'rtl' : 'ltr'}>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24">
            <div>
              <h2 className="text-3xl font-black text-zinc-100 mb-6 tracking-tight">
                  ...
                  {processList.map((step: any, i: number) => {
                    ...
                    return (
                      <li key={i} className="flex items-start gap-4">
                        ...
                        <div>
                          <div className="text-zinc-100 font-bold mb-1">{stepTitle}</div>
                          <div className="text-zinc-400 text-sm">{stepDesc}</div>
                        </div>
                      </li>
                    );
                  })}
      ...
      {service.gallery && service.gallery.length > 0 && (
        <section className="py-24 border-t border-zinc-800">
          <div className="container mx-auto px-4 md:px-8">
            <h2 className="text-3xl font-black text-zinc-100 tracking-tight mb-12">
